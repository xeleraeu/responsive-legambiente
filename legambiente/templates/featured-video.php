...
<div id="<?php echo $featured_video_uniqid; ?>" class="pods-video">
  <?php if($featured_video->field('youtube_id')): ?>
    <iframe type="text/html" width="100%" height="auto" src="http://www.youtube.com/embed/<?php echo $featured_video->field('youtube_id'); ?>?autoplay=0&origin=http://example.com" frameborder="0"/>
  <?php elseif($featured_video->field('vimeo_id')): ?>
    <iframe src="http://player.vimeo.com/video/<?php echo $featured_video->field('vimeo_id'); ?>" width="100%" height="auto" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
